...
*/
  ...
  #if defined(SDCARD_RECORD_EEPROM_LOGO)
    // do this first, so that we get the logo written to eeprom, and then display it
    write_sdcard_logo_to_eeprom();
  #endif
