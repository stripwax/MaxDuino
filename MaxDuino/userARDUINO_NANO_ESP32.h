////////////////                 CONFIG FOR NEW ARDUINO NANO ESP32             ////////////////////////////

#define SD_SPI_CLOCK_SPEED SD_SCK_MHZ(20) // 20 MHz is the maximum speed for the SD card on the Nano ESP32
...
//define OLED1306_INVERSE // set oled inverse
...
#define scrollWait 1000 // Delay before scrolling starts
#define scrollSpeed 80 // text scroll delay
